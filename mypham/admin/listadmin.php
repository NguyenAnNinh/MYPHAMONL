          ...
          <div class="content col-xs-9 col-sm-9 col-lg-9">
            <div class="container">
              <div class="header-content">
                ...
                <a class="add-user" title="Add user" href="admin_addadmin.php">
              ...
              <?php
                $sql = "SELECT * FROM admin inner join role on admin.role=role.idrole";
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <li><a href="admin_edituser.php?id=<?=$id?>" title="Edit" class="edit" itemprop="<?=$id?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li> -->
                      <li><a href="" title="Delete" class="remove" itemprop="<?=$idadmin?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a></li>
                    </td>
                  </tr>
              <?php
                }
